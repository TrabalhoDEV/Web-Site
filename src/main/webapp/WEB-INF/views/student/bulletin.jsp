        ...
        <section>
            <div class="boletim-grid">
                <div class="boletim-header">
                    <h3>Boletim</h3>
                    <a href="${pageContext.request.contextPath}/student/bulletin/generate-pdf" target="_blank">Exportar
                        para PDF</a>
                </div>
                <hr>
                ...
                <table class="grade-table"
                       style="--cols: 5; grid-template-columns: 2fr 60px 60px 60px fit-content(120px)">
                    <thead>
                    <tr>
                        <th>Matéria</th>
                        <th>Nota 1</th>
                    ...
                    <tr>
                        ...
                        <td style="padding: 12px 0 12px 0"><span
                                class="status <%= ss.getStatus() == "Aprovado" ? "approved" : (ss.getStatus() == "Reprovado" ? "reproved" : "pending")%>"><%= ss.getStatus() %></span>
                        </td>
                    </tr>
                    <%
                        }
