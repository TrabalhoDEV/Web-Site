...
<head>
    ...
    <link rel="shortcut icon" href="<%= request.getContextPath() %>/assets/css/img/Logo%20-%20Vértice.svg" type="image/x-icon">
</head>
<body>
    ...
    <main class="main-content">
        ...
        <section class="hero">
            ...
            <div class="hero-illustration">
                <img src="<%= request.getContextPath() %>/assets/css/img/gato.svg" alt="Ilustração gato"/>
            </div>
        </section>
