...
<head>
    ...
    <title>Detalhes do Professor | Vértice</title>
            ...
            <div class="detail-grid">
                ...
                <div class="info-section">
                    <div class="info-row">
                        ...
                        <span class="value"><%= OutputFormatService.formatName(teacher.getName()) %></span>
                    </div>
                    <div class="info-row">
                        <span class="label">Usuário:</span>
                        <span class="value"><%= teacher.getUsername() %></span>
                    </div>
                    <div class="info-row">
                        <span class="label">Email:</span>
                        <span class="value"><%= teacher.getEmail() %></span>
                    </div>
                </div>
