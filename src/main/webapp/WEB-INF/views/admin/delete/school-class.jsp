    ...
    <main class="main-content">
        ...
        <section>
            <div class="boletim-grid">
                ...
                <p>Essa turma possui alunos, para deletá-la, escolha outra turma para redirecioná-los</p>

                <form action="${pageContext.request.contextPath}/admin/school-class/delete" method="post" class="generic-form" style="margin-top: 12px">
                    ...
                    <select id="anoEscolar" name="newId" required>
                        ...
                        <option value="<%=schoolClass.getId()%>"><%= schoolClass.getSchoolYear().toUpperCase()%>
                        </option>
                        <%}%>
                        <%}%>
                    </select>
                    ...
                    <p style="color: #9b0404; text-align: start"><%=request.getAttribute("error")%>
                    </p>
                    <%}%>
