        ...
        <svg class="l" xmlns="http://www.w3.org/2000/svg" width="101" height="51" viewBox="0 0 101 51" fill="none">
            ...
            <defs>
                <linearGradient id="paint0_linear_1031_100" x1="49.2504" y1="5.53041" x2="18.9897" y2="61.3871" gradientUnits="userSpaceOnUse">
                    <stop stop-color="white"/><stop offset="0.474208" stop-color="#7C3AED"/><stop offset="0.688674" stop-color="#2C18A3"/>
                </linearGradient>
                <linearGradient id="paint1_linear_1031_100" x1="10.1986" y1="-0.000549608" x2="-5.99272" y2="31.0281" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#4361EE"/><stop offset="1" stop-color="#7C3AED"/>
                </linearGradient>
                ...
                <linearGradient id="paint3_linear_1031_100" x1="-24.1112" y1="30.3485" x2="5.30444" y2="10.6473" gradientUnits="userSpaceOnUse">
                    <stop offset="0.422047" stop-color="white"/><stop offset="1" stop-color="white" stop-opacity="0"/>
                </linearGradient>
                <linearGradient id="paint4_linear_1031_100" x1="12.9604" y1="31.9683" x2="22.8868" y2="54.964" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#7F96FD"/><stop offset="1" stop-color="#4361EE"/>
                </linearGradient>
                <linearGradient id="paint5_linear_1031_100" x1="21.3379" y1="7.2049" x2="95.3682" y2="7.2049" gradientUnits="userSpaceOnUse">
                    <stop offset="0.0384615" stop-color="#FF5B5B"/><stop offset="0.625" stop-color="#FF0080"/><stop offset="0.75" stop-color="#FF1777"/><stop offset="1" stop-color="#FF0080"/>
                </linearGradient>
                <linearGradient id="paint6_linear_1031_100" x1="10.8084" y1="16.239" x2="99.231" y2="4.68151" gradientUnits="userSpaceOnUse">
                    <stop offset="0.125" stop-color="#F980BF"/><stop offset="0.274038" stop-color="#E962DA"/><stop offset="0.456731" stop-color="#7C3AED"/><stop offset="1" stop-color="#43AAEE"/>
                </linearGradient>
                <linearGradient id="paint7_linear_1031_100" x1="20.2365" y1="13.2296" x2="95.0729" y2="3.4025" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FFBCAA"/><stop offset="0.168269" stop-color="#FF93DB"/><stop offset="0.341346" stop-color="#AA5DED"/><stop offset="0.788462" stop-color="#7CBFFA"/>
                </linearGradient>
            </defs>
        </svg>
    </div>
                ...
                <a href="${pageContext.request.contextPath}/admin/school-class/find-many">
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M14 21v-3a2 2 0 0 0-4 0v3"/><path d="M18 5v16"/><path d="m4 6 7.106-3.79a2 2 0 0 1 1.788 0L20 6"/>
    ...
    <section>
        <div class="boletim-grid">
            ...
            <div class="header-grid">
                <h1>Matérias da Turma</h1>

                <form method="get" action="${pageContext.request.contextPath}/admin/school-class/subject/find-many"
                      class="form-filter">
                    <section>
                        <input type="hidden" name="classId" value="<%= classId %>"/>
                        <input type="text" name="filter" value="<%= filter %>" placeholder="Nome da matéria"/>
                        <input type="hidden" name="page" value="1"/>
                        <button type="submit" class="primary-button">Buscar</button>
                        <a href="${pageContext.request.contextPath}/admin/school-class/subject/find-many?classId=<%= classId %>"
                           class="secondary-button">Limpar</a>
                    </section>
            ...
            <table class="grade-table" style="--cols: 3; grid-template-columns: 2fr 1fr 90px">
                <thead>
                <tr>
                    <th>Nome</th>
                    <th>Data Limite</th>
                ...
                <tr>
                    <td><%= OutputFormatService.formatName(subject.getName()) %></td>
                    <td><%= OutputFormatService.formatDate(subject.getDeadline()) %></td>
                    <td class="actions">
                        <div class="btn-action">
                            <a href="${pageContext.request.contextPath}/admin/school-class/subject/update?subjectId=<%= subject.getId() %>&classId=<%= classId %>">
                            ...
                            <a href="#"
                               onclick="openModalDelete('${pageContext.request.contextPath}/admin/school-class/subject/delete?classId=<%= classId %>&subjectId=<%= subject.getId() %>')">
                                <button title="Remover da turma" class="btn-icon btn-delete">
                                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                         stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <p class="not-found">Nenhuma matéria atende a esse(s) filtro(s)</p>

            <% } else if (request.getAttribute("error") == null) { %>
            <p class="not-found">Nenhuma matéria foi encontrada para esta turma</p>
            <% } %>
        </div>
        ...
        <div class="pagination">
            <% if (currentPage > 1) { %>
            <a href="${pageContext.request.contextPath}/admin/school-class/subject/find-many?classId=<%= classId %>&page=<%= currentPage - 1 %>&filter=<%= filter %>">Anterior</a>
            <% } %>

            <strong><%= currentPage != 0 ? currentPage : 1 %>/<%= totalPages != 0 ? totalPages : 1 %></strong>

            <% if (currentPage < totalPages) { %>
            <a href="${pageContext.request.contextPath}/admin/school-class/subject/find-many?classId=<%= classId %>&page=<%= currentPage + 1 %>&filter=<%= filter %>">Próxima</a>
            <% } %>
        </div>
    </section>
</main>
