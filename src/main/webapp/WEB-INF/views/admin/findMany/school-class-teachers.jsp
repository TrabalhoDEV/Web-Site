  ...
  <div class="sidebar-logo">
    <svg class="l" xmlns="http://www.w3.org/2000/svg" width="101" height="51" viewBox="0 0 101 51" fill="none">
      ...
      <g mask="url(#mask1_1031_100)">
        <mask id="mask2_1031_100" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="-1" y="-1" width="22"
              height="35">
      ...
      <defs>
        ...
        <linearGradient id="paint1_linear_1031_100" x1="10.1986" y1="-0.000549608" x2="-5.99272" y2="31.0281"
                        gradientUnits="userSpaceOnUse">
          <stop stop-color="#4361EE"/>
          <stop offset="1" stop-color="#7C3AED"/>
        </linearGradient>
        <linearGradient id="paint2_linear_1031_100" x1="10.1986" y1="-0.000549608" x2="-5.99272" y2="31.0281"
                        gradientUnits="userSpaceOnUse">
          <stop offset="1" stop-color="#7C3AED"/>
        </linearGradient>
  ...
  <section>
    <div class="boletim-grid">
      ...
      <div class="header-grid">
        ...
        <form method="get" action="${pageContext.request.contextPath}/admin/school-class/teacher/find-many"
              class="form-filter">
          <section>
      ...
      <p class="not-found">Nenhum professor(a) foi encontrado</p>
      <% } %>
    </div>
    ...
    <div class="pagination">
      ...
      <% if (currentPage > 1) { %>
      <a href="${pageContext.request.contextPath}/admin/school-class/teacher/find-many?classId=<%= classId%>&page=<%= currentPage - 1 %>&filter=<%= filter %>">Anterior</a>
      <% } %>
      ...
      <a href="${pageContext.request.contextPath}/admin/school-class/teacher/find-many?classId=<%= classId%>&page=<%= currentPage + 1 %>&filter=<%= filter %>">Próxima</a>
      <% } %>
...
<dialog id="deleteDialog">
  <div class="modal-card">
    <h3>Deseja deletar esta matéria desta turma?</h3>
