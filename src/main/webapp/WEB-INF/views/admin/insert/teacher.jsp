  ...
  <main class="main-content">
    ...
    <section>
      <div class="boletim-grid">
        ...
        <form action="${pageContext.request.contextPath}/admin/teacher/insert" method="post" class="teacher-form">
          ...
          <div class="form-group">
            ...
            <input type="email" id="email" name="email" placeholder="Digite o e-mail do professor" required>
          </div>

          <div class="form-group">
            <label for="username">Usuário:</label>
            <input type="text" id="username" name="username" placeholder="Digite o username do professor" required>
          </div>

          <div class="form-group">
            <label for="password">Senha:</label>
            <input type="password" id="password" name="password" placeholder="Digite a senha do professor" required>
          </div>
          ...
          <div class="form-actions">
            ...
            <a href="${pageContext.request.contextPath}/admin/teacher/find-many" class="secondary-button">
              Cancelar
            </a>
          </div>
        </form>
