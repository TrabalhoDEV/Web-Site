...
<head>
    ...
    <title>Editar Matéria | Vértice</title>
    ...
    <main class="main-content">
        <section>
            <div class="boletim-grid">
                ...
                <form action="${pageContext.request.contextPath}/admin/subject/update" method="post" class="update-subject-form">
                    ...
                    <input name="id" type="hidden" value="<%= subject.getId() %>">
                ...
                <a href="${pageContext.request.contextPath}/admin/subject/find-many" class="blue_button">Voltar</a>
            </div>
        </section>
    </main>
</div>
