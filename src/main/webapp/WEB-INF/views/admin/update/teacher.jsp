            ...
            <div class="boletim-grid">
                ...
                <form action="${pageContext.request.contextPath}/admin/teacher/update" method="post" class="generic-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" value="<%=OutputFormatService.formatName(teacher.getName())%>" placeholder="Digite o nome do professor" required>
                    </div>

                    <div class="form-group">
                        <label for="email">Email:</label>
                        <input type="email" id="email" name="email" value="<%=teacher.getEmail()%>" placeholder="Digite o e-mail do professor" required>
                    </div>
