...
<head>
    ...
    <title>Dashboard — Vértice</title>
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/assets/img/Logo%20-%20Vértice.svg" type="image/x-icon">
    ...
    <aside class="sidebar">
        <div class="sidebar-logo">
            <svg class="l" xmlns="http://www.w3.org/2000/svg" width="101" height="51" viewBox="0 0 101 51" fill="none">
                <mask id="mask0_1031_100" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="22" y="16" width="23" height="35"><path d="M44.8174 16.743H42.2769C37.4619 16.743 33.1938 19.5943 31.7032 23.8067L22.4088 50.0716H28.13C31.0482 50.0716 33.6349 48.3436 34.5383 45.7906L44.8174 16.743Z" fill="#D9D9D9"/></mask>
                <g mask="url(#mask0_1031_100)"><path d="M43.9043 16.9796H41.3638C36.5488 16.9796 32.2808 19.8308 30.7901 24.0433L21.4957 50.3082H27.2169C30.1351 50.3082 32.7218 48.5802 33.6252 46.0272L43.9043 16.9796Z" fill="url(#paint0_linear_1031_100)"/></g>
                <mask id="mask1_1031_100" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="5" y="16" width="24" height="35"><path d="M5.72852 16.743C12.1432 17.1178 17.6682 21.0381 19.6921 26.651L28.1371 50.0716H22.4159C19.4977 50.0716 16.911 48.3436 16.0076 45.7906L5.72852 16.743Z" fill="#D9D9D9"/></mask>
                <g mask="url(#mask1_1031_100)">
                    <mask id="mask2_1031_100" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="-1" y="-1" width="22" height="35"><path d="M-0.260742 -0.000549316C6.16642 0.374903 11.7172 4.27047 13.8099 9.87421L20.658 28.2125L11.5332 33.328L-0.260742 -0.000549316Z" fill="url(#paint1_linear_1031_100)"/></mask>
                    <g mask="url(#mask2_1031_100)"><path d="M-0.260742 -0.000549316C6.16642 0.374903 11.7172 4.27047 13.8099 9.87421L20.658 28.2125L11.5332 33.328L-0.260742 -0.000549316Z" fill="url(#paint2_linear_1031_100)"/></g>
                ...
                <mask id="mask3_1031_100" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="21" y="0" width="75" height="15"><path d="M95.3682 14.2795C95.3682 14.6376 78.3291 0.123779 57.8862 0.123779C37.4433 0.123779 21.3379 14.6376 21.3379 14.2795C24.699 14.2795 37.4433 4.31548 57.8862 4.31548C78.3291 4.31548 92.5734 14.3751 95.3682 14.2795Z" fill="url(#paint5_linear_1031_100)"/></mask>
                ...
                <defs>
                    <linearGradient id="paint0_linear_1031_100" x1="49.2504" y1="5.53041" x2="18.9897" y2="61.3871" gradientUnits="userSpaceOnUse"><stop stop-color="white"/><stop offset="0.474208" stop-color="#7C3AED"/><stop offset="0.688674" stop-color="#2C18A3"/></linearGradient>
                    <linearGradient id="paint1_linear_1031_100" x1="10.1986" y1="-0.000549608" x2="-5.99272" y2="31.0281" gradientUnits="userSpaceOnUse"><stop stop-color="#4361EE"/><stop offset="1" stop-color="#7C3AED"/></linearGradient>
                    <linearGradient id="paint2_linear_1031_100" x1="10.1986" y1="-0.000549608" x2="-5.99272" y2="31.0281" gradientUnits="userSpaceOnUse"><stop offset="1" stop-color="#7C3AED"/></linearGradient>
                    <linearGradient id="paint3_linear_1031_100" x1="-24.1112" y1="30.3485" x2="5.30444" y2="10.6473" gradientUnits="userSpaceOnUse"><stop offset="0.422047" stop-color="white"/><stop offset="1" stop-color="white" stop-opacity="0"/></linearGradient>
                    <linearGradient id="paint4_linear_1031_100" x1="12.9604" y1="31.9683" x2="22.8868" y2="54.964" gradientUnits="userSpaceOnUse"><stop stop-color="#7F96FD"/><stop offset="1" stop-color="#4361EE"/></linearGradient>
                    <linearGradient id="paint5_linear_1031_100" x1="21.3379" y1="7.2049" x2="95.3682" y2="7.2049" gradientUnits="userSpaceOnUse"><stop offset="0.0384615" stop-color="#FF5B5B"/><stop offset="0.625" stop-color="#FF0080"/><stop offset="0.75" stop-color="#FF1777"/><stop offset="1" stop-color="#FF0080"/></linearGradient>
                    <linearGradient id="paint6_linear_1031_100" x1="10.8084" y1="16.239" x2="99.231" y2="4.68151" gradientUnits="userSpaceOnUse"><stop offset="0.125" stop-color="#F980BF"/><stop offset="0.274038" stop-color="#E962DA"/><stop offset="0.456731" stop-color="#7C3AED"/><stop offset="1" stop-color="#43AAEE"/></linearGradient>
                    <linearGradient id="paint7_linear_1031_100" x1="20.2365" y1="13.2296" x2="95.0729" y2="3.4025" gradientUnits="userSpaceOnUse"><stop stop-color="#FFBCAA"/><stop offset="0.168269" stop-color="#FF93DB"/><stop offset="0.341346" stop-color="#AA5DED"/><stop offset="0.788462" stop-color="#7CBFFA"/></linearGradient>
                </defs>
            </svg>
        </div>
              ...
              <span class="icon">
                ...
                <li class="sidebar-item active">
                    <a href="${pageContext.request.contextPath}/admin/dashboard">
                        <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg></span>
                        <span>Dashboard</span>
                    </a>
                </li>
    ...
    <main class="main-content">
        ...
        <div class="dash-header">
            <div class="dash-header-left">
                <h1>Dashboard - Visão geral do desempenho acadêmico</h1>
            </div>
            <button id="btn-refresh" class="btn-refresh" onclick="loadAll()">
        ...
        <div class="kpi-grid">
            <div class="kpi-card" data-color="violet">
                <div class="kpi-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 21 22" fill="none"><path d="M20.487 9.26L11.737.51A1.75 1.75 0 0 0 10.5 0c-.464 0-.909.184-1.237.512L.513 9.26A1.75 1.75 0 0 0 0 10.5v10.5c0 .483.368.875.875.875h19.25c.483 0 .875-.392.875-.875V10.5a1.75 1.75 0 0 0-.513-1.24ZM19.25 20.125H1.75V10.5L10.5 1.75l8.75 8.75v9.625Z" fill="currentColor"/><rect x="9" y="15" width="3" height="3" rx="1" fill="currentColor"/></svg>
                </div>
            ...
            <div class="kpi-card" data-color="amber">
                <div class="kpi-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 21v-3a2 2 0 0 0-4 0v3"/><path d="M18 5v16"/><path d="m4 6 7.106-3.79a2 2 0 0 1 1.788 0L20 6"/><path d="m6 11-3.52 2.147A1 1 0 0 0 2 14v5a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5a1 1 0 0 0-.48-.853L18 11"/><path d="M6 5v16"/><circle cx="12" cy="9" r="2"/></svg>
                </div>
                <div class="kpi-label">Turmas</div>
                <div class="kpi-value" id="kpi-classes">—</div>
                <div class="kpi-sub">em andamento</div>
            </div>

            <div class="kpi-card" data-color="blue">
                <div class="kpi-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="14" x="3" y="5" rx="2" ry="2"/><path d="M7 15h4M15 15h2M7 11h2M13 11h4"/></svg>
                </div>
                <div class="kpi-label">Matérias</div>
                <div class="kpi-value" id="kpi-subjects">—</div>
                <div class="kpi-sub">ensinadas</div>
            </div>
        </div>

        <div class="kpi-wide-row">
            <div class="kpi-card-wide">
                <div class="kpi-wide-icon">🏆</div>
                <div class="kpi-wide-body">
                    <div class="kpi-wide-label">Turma com mais alunos</div>
                    <div class="kpi-wide-value" id="kpi-top-class">—</div>
                    <div class="kpi-wide-meta">
                        <strong id="kpi-max-students">—</strong> alunos nesta turma &nbsp;·&nbsp;
                        média de <strong id="kpi-avg">—</strong> alunos por turma
                    </div>
                </div>
            </div>
        </div>

        <p class="section-title">Desempenho Acadêmico</p>
        <div class="charts-row" style="margin-bottom:16px">
            <div class="chart-card">
                <div class="chart-head">
                    <div class="chart-head-left">
                        <span class="chart-dot" style="background:#6d28d9"></span>
                        <h2 class="chart-title">Média por Disciplina</h2>
                    </div>
                    <span class="chart-badge">Ranking</span>
                </div>
                <div class="chart-wrap"><canvas id="chartSubjectGrades"></canvas></div>
            </div>
            <div class="chart-card">
                <div class="chart-head">
                    <div class="chart-head-left">
                        <span class="chart-dot" style="background:#2563eb"></span>
                        <h2 class="chart-title">Média por Turma</h2>
                    </div>
                    <span class="chart-badge">Comparativo</span>
                </div>
                <div class="chart-wrap"><canvas id="chartClassGrades"></canvas></div>
            </div>
        </div>
            ...
            <div class="chart-card">
                <div class="chart-head">
                    <div class="chart-head-left">
                        ...
                        <h2 class="chart-title">Taxa de Aprovação por Turma</h2>
                    </div>
                    <span class="chart-badge">%</span>
                </div>
                <div class="chart-wrap"><canvas id="chartApproval"></canvas></div>
            </div>
            <div class="chart-card">
                <div class="chart-head">
                    <div class="chart-head-left">
                        <span class="chart-dot" style="background:#d97706"></span>
                        <h2 class="chart-title">Alunos por Turma</h2>
                    </div>
                    <span class="chart-badge">Distribuição</span>
                </div>
                <div class="chart-wrap"><canvas id="chartStudentsPerClass"></canvas></div>
            </div>
        </div>

        <%-- Charts row 3 --%>
        <p class="section-title">Carga Docente</p>
        <div class="charts-row">
            <div class="chart-card">
                <div class="chart-head">
                    <div class="chart-head-left">
                        <span class="chart-dot" style="background:#d97706"></span>
                        <h2 class="chart-title">Disciplinas por Professor</h2>
                    </div>
                    <span class="chart-badge">Top 10</span>
                </div>
                <div class="chart-wrap chart-wrap--tall"><canvas id="chartSubjectsTeacher"></canvas></div>
            </div>
            <div class="chart-card">
                <div class="chart-head">
                    <div class="chart-head-left">
                        <span class="chart-dot" style="background:#dc2626"></span>
                        <h2 class="chart-title">Turmas por Professor</h2>
                    </div>
                    <span class="chart-badge">Top 10</span>
                </div>
                <div class="chart-wrap chart-wrap--tall"><canvas id="chartClassesTeacher"></canvas></div>
            </div>
        </div>
...
<%-- Loading overlay (fora do main para cobrir tudo) --%>
