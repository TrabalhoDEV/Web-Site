    ...
    <main class="main-content">
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <a href="${pageContext.request.contextPath}/teacher/student/find-many">
                    <button class="primary-button">Ver alunos</button>
                </a>
        ...
        <section class="dashboard-grid">
            <div class="dashboard-view">
                <article class="card-tasks">
                    <header class="card-header pendences">
                        <h2>Pendências</h2>
                    </header>
                    ...
                    <ul class="task-list">
                        ...
                        <li class="task">
                            <div>
                                <strong class="task-title"><%=pendency.grade1() == null && pendency.grade2() == null ? String.format("Lançar notas - %s", OutputFormatService.formatName(pendency.studentName()))
                                ...
                                <p><span class="icon-status">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="22" viewBox="0 0 21 22" fill="none">
                      <path d="M18.6451 1.66241H16.1026V0.831206C16.1026 0.610756 16.0133 0.399336 15.8544 0.243455C15.6954 0.0875732 15.4798 0 15.2551 0C15.0303 0 14.8147 0.0875732 14.6558 0.243455C14.4969 0.399336 14.4076 0.610756 14.4076 0.831206V1.66241H5.93253V0.831206C5.93253 0.610756 5.84324 0.399336 5.6843 0.243455C5.52536 0.0875732 5.3098 0 5.08502 0C4.86025 0 4.64469 0.0875732 4.48575 0.243455C4.32681 0.399336 4.23752 0.610756 4.23752 0.831206V1.66241H1.69501C1.24546 1.66241 0.814332 1.83756 0.496456 2.14932C0.178581 2.46108 0 2.88392 0 3.32482V19.9489C0 20.3898 0.178581 20.8127 0.496456 21.1244C0.814332 21.4362 1.24546 21.6114 1.69501 21.6114H18.6451C19.0946 21.6114 19.5258 21.4362 19.8436 21.1244C20.1615 20.8127 20.3401 20.3898 20.3401 19.9489V3.32482C20.3401 2.88392 20.1615 2.46108 19.8436 2.14932C19.5258 1.83756 19.0946 1.66241 18.6451 1.66241ZM4.23752 3.32482V4.15603C4.23752 4.37648 4.32681 4.5879 4.48575 4.74378C4.64469 4.89966 4.86025 4.98724 5.08502 4.98724C5.3098 4.98724 5.52536 4.89966 5.6843 4.74378C5.84324 4.5879 5.93253 4.37648 5.93253 4.15603V3.32482H14.4076V4.15603C14.4076 4.37648 14.4969 4.5879 14.6558 4.74378C14.8147 4.89966 15.0303 4.98724 15.2551 4.98724C15.4798 4.98724 15.6954 4.89966 15.8544 4.74378C16.0133 4.5879 16.1026 4.37648 16.1026 4.15603V3.32482H18.6451V6.64965H1.69501V3.32482H4.23752ZM18.6451 19.9489H1.69501V8.31206H18.6451V19.9489ZM11.4413 12.0525C11.4413 12.2991 11.3667 12.5401 11.2271 12.7452C11.0874 12.9502 10.8888 13.11 10.6565 13.2044C10.4242 13.2988 10.1686 13.3234 9.92204 13.2753C9.67544 13.2272 9.44892 13.1085 9.27114 12.9341C9.09335 12.7597 8.97227 12.5376 8.92322 12.2957C8.87417 12.0539 8.89934 11.8032 8.99556 11.5754C9.09178 11.3475 9.25472 11.1528 9.46378 11.0158C9.67283 10.8788 9.91862 10.8057 10.17 10.8057C10.5072 10.8057 10.8306 10.937 11.069 11.1709C11.3074 11.4047 11.4413 11.7218 11.4413
567 10.6328 13.1465C10.4118 13.2362 10.1682 13.2596 9.93359 13.2139C9.69905 13.168 9.48332 13.0553 9.31445 12.8896C9.14557 12.724 9.03091 12.5126 8.98438 12.2832C8.93787 12.0538 8.96145 11.8158 9.05273 11.5996C9.14405 11.3834 9.29931 11.1986 9.49805 11.0684C9.69682 10.9381 9.93063 10.8682 10.1699 10.8682ZM14.8311 10.8682C15.152 10.8682 15.4599 10.9936 15.6865 11.2158C15.913 11.438 16.04 11.7391 16.04 12.0527C16.04 12.2866 15.9695 12.5153 15.8369 12.71C15.7042 12.9047 15.515 13.0567 15.2939 13.1465C15.0731 13.2361 14.8302 13.2595 14.5957 13.2139C14.3611 13.1681 14.1455 13.0552 13.9766 12.8896C13.8076 12.7239 13.6921 12.5127 13.6455 12.2832C13.599 12.0538 13.6235 11.8158 13.7148 11.5996C13.8062 11.3835 13.9605 11.1986 14.1592 11.0684C14.3579 10.9381 14.5918 10.8682 14.8311 10.8682ZM1.63281 6.71191H18.708V3.2627H16.04V4.15625C16.04 4.35965 15.9576 4.55501 15.8105 4.69922C15.6634 4.84349 15.4634 4.9248 15.2549 4.9248C15.0464 4.92476 14.8463 4.84347 14.6992 4.69922C14.5523 4.55503 14.4698 4.35958 14.4697 4.15625V3.2627H5.87012V4.15625C5.87006 4.35964 5.78765 4.55501 5.64062 4.69922C5.4935 4.84352 5.29354 4.9248 5.08496 4.9248C4.8764 4.92479 4.67641 4.8435 4.5293 4.69922C4.38231 4.55502 4.29986 4.35961 4.2998 4.15625V3.2627H1.63281V6.71191Z"
                            stroke="#E0E4F4" stroke-opacity="0.65" stroke-width="0.125"/>
                    </svg>
                </span>Prazo: <span class="date overdue"><%=OutputFormatService.formatDate(pendency.deadline())%></span>
                ...
                <div class="lateral">
                        ...
                        <div class="performance-content">
                            ...
                            <div class="performance-wrapper">
                                <div class="performance-row">
                                    <div class="pill approved"><%= studentsPerformance.approved()%>%</div>
                                    <div class="pill failed"><%= studentsPerformance.failed()%>%</div>
                                </div>
                                <div class="performance-row center">
                                    <div class="pill pending"><%= studentsPerformance.pending()%>%</div>
                                </div>
                                <div class="performance-legend">
                                    <span><i class="dot approved"></i> Aprovados</span>
                                    <span><i class="dot failed"></i> Reprovados</span>
                                    <span><i class="dot pending"></i> Pendentes</span>
                                </div>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="card-students-alert">
                        <header class="card-header">
                            <h2>Alunos em atenção</h2>
                        </header>
                        <ul class="student-list">
                            <%if (studentSubjectMap != null && !studentSubjectMap.isEmpty()) {%>
                            <%for (StudentSubject studentSubject : studentSubjectMap.values()) {%>
                            <li class="student-alert">
                                <div class="info-alert">
                                    <strong class="task-title"><%=OutputFormatService.formatName(studentSubject.getStudent().getName())%>
                                    </strong>
                                    <span>Média: <span class="avg"><%=studentSubject.getAverage()%></span></span>
                                </div>
                            </li>
                            <%}%>
                            <%} else {%>
