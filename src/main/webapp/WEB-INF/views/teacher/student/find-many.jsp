...
<%
    ...
    if (request.getAttribute("studentSubjectMap") != null) studentSubjectMap = (Map<Integer, List<StudentSubject>>) request.getAttribute("studentSubjectMap");
            ...
            <ul>
              ...
              <span class="icon">
                ...
                <li class="sidebar-item active">
                    <a href="${pageContext.request.contextPath}/teacher/student/find-many">
            <span class="icon">
    ...
    <main class="main-content">
        ...
        140px;">
                    ...
                    <tr>
                        ...
                        <td><span
                                class="status <%= ss.getStatus().equals("Aprovado") ? "approved" : (ss.getStatus().equals("Reprovado") ? "reproved" : "pending")%>"><%= ss.getStatus()%>
                            </span></td>
                        <td>
                            <form action="${pageContext.request.contextPath}/teacher/students/grades/render"
                                  method="post">
